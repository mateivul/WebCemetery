    ...
    constructor() {
        this.templates = {
            ...
            resource: [
                ...
                `{{domain}} - Performance killer, finally eliminated`,
            ...
            generic: [
                ...
                `"{{title}}" - Another casualty of procrastination`,
                `Rest in pixels - {{domain}}`,
                `{{title}} has left the building`,
                `In loving memory of a tab that was never read`,
                `"{{title}}" - Too many tabs, too little time`,
            ...
            witty: [
                ...
                `{{domain}} - Refreshed in another world now`,
        ...
        this.domainCategories = {
            ...
            news: ["nytimes.com", "bbc.com", "cnn.com", "theguardian.com", "reuters.com", "news.ycombinator.com"],
